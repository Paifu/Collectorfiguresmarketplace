  ...
  const renderNavItem = (item: typeof navItems[0], closeMobile?: () => void) => (
    <NavLink
      ...
      className={({ isActive }) => {
        ...
        return `flex items-center gap-2.5 px-3 py-2 rounded-lg transition-colors ${
    ...
    <div className="min-h-screen flex bg-background">
      ...
      <aside className="hidden md:flex flex-col w-56 border-r border-border bg-card px-3 py-5 shrink-0">
        ...
        <div
          ...
          className="flex items-center gap-2.5 mb-8 px-2 cursor-pointer select-none"
        >
